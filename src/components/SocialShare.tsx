    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-56">
        ...
        <DropdownMenuItem onClick={() => handleShare('pinterest')}>
          <div className="h-4 w-4 mr-2 text-[#E60023]">
            <PinterestIcon />
          </div>
          Pinterest
        </DropdownMenuItem>
        ...
        <DropdownMenuItem onClick={() => handleShare('whatsapp')}>
          <div className="h-4 w-4 mr-2 text-[#25D366]">
            <WhatsAppIcon />
          </div>
          WhatsApp
        </DropdownMenuItem>
        ...
        <DropdownMenuItem onClick={() => handleShare('linkedin')}>
          <svg className="h-4 w-4 mr-2 text-[#0A66C2]" viewBox="0 0 24 24" fill="currentColor">
